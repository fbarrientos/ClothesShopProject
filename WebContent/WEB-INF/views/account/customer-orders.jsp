...
<div class="container">
 ...
 _________________________________________________________ -->
		<div class="panel panel-default sidebar-menu">
			...
			<div class="panel-heading">
				<h3 class="panel-title">Welcome: ${sessionScope.username}</h3>
			</div>
			...
			<div class="panel-body">
				...
				<ul class="nav nav-pills nav-stacked">
					...
					<li><a href="customer-account.html"><i class="fa fa-user"></i>
							My account</a></li>
					<li><a href="${pageContext.request.contextPath}/account/logout.htm"><i class="fa fa-sign-out"></i>
							Logout</a></li>
				</ul>
			</div>
