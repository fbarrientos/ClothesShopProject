			...
			<div class="panel-body">
				<ul class="nav nav-pills nav-stacked category-menu">
					<c:forEach var="category1" items="${categories }">
						<li class="active"><a href="category.html">${category1.name }
								<span class="badge pull-right">42</span>
						</a> <c:if test="${category1.categories.size() > 0 }">
								<ul>
			...
			<div class="social">
				...
				<p>
					<a href="#" class="external facebook" data-animate-hover="pulse"><i
						...
						data-animate-hover="pulse"><i class="fa fa-google-plus"></i></a> <a
						href="#" class="external twitter" data-animate-hover="pulse"><i
